      ...
      for ($i=1; $i < 4; $i++)
      {
        ...
        if( $query_posts->have_posts()) :
          while ( $query_posts->have_posts() ) :
            ...
            $c++;
            if ( $c == 1 ) { $class = "col-md-12 mb-10"; } else { $class = 'col-md-4'; }
            ?>

            <article class="row ptb-10 <?php echo $c == 1 ? "first" : "" ?>">

                <div class="<?php echo $class; ?>" <?php echo $c == 1 ? "data-effict-zoom='1'" : "" ?> >
                ...
                <div class="detail <?php echo $c == 1 ? "col-md-12" : "col-md-8" ?>">
