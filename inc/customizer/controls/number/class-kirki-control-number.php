...
class Kirki_Control_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script( 'kirki-number', 'numberKirkiL10n', array(
			'min-error'  => esc_attr__( 'Value lower than allowed minimum', 'civitas' ),
			'max-error'  => esc_attr__( 'Value higher than allowed maximum', 'civitas' ),
			'step-error' => esc_attr__( 'Invalid Value', 'civitas' ),
		) );
	}
