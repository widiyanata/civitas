...
class Kirki_Control_Gradient extends WP_Customize_Control {
	...
	protected function content_template() {
		...
		<div class="global">
			<!-- <div class="mode">
				<h4><?php esc_attr_e( 'Mode', 'civitas' ); ?></h4>
				<input class="switch-input screen-reader-text" type="radio" value="linear" name="_customize-gradient-{{{ data.id }}}" id="{{ data.id }}linear" <# if ( ! _.isUndefined( data.value.mode ) && 'linear' === data.value.mode ) { #> checked="checked" <# } #>>
					<label class="switch-label switch-label-<# if ( ! _.isUndefined( data.value.mode ) && 'linear' === data.value.mode ) { #>on <# } else { #>off<# } #>" for="{{ data.id }}linear"><span class="dashicons dashicons-minus"></span><span class="screen-reader-text"><?php esc_attr_e( 'Linear', 'civitas' ); ?></span></label>
				</input>
				<input class="switch-input screen-reader-text" type="radio" value="radial" name="_customize-gradient-{{{ data.id }}}" id="{{ data.id }}radial" <# if ( ! _.isUndefined( data.value.mode ) && 'radial' === data.value.mode ) { #> checked="checked" <# } #>>
					<label class="switch-label switch-label-<# if ( ! _.isUndefined( data.value.mode ) && 'radial' === data.value.mode ) { #>on <# } else { #>off<# } #>" for="{{ data.id }}radial"><span class="dashicons dashicons-marker"></span><span class="screen-reader-text"><?php esc_attr_e( 'Radial', 'civitas' ); ?></span></label>
				</input>
			</div> -->
			<div class="angle">
				<h4><?php esc_attr_e( 'Angle', 'civitas' ); ?></h4>
		...
		<div class="colors">
			<div class="color-start">
				<div class="color">
					<h4><?php esc_attr_e( 'Start Color', 'civitas' ); ?></h4>
				...
				<div class="position">
					<h4><?php esc_attr_e( 'Color Stop', 'civitas' ); ?></h4>
			...
			<div class="color-end">
				<div class="color">
					<h4><?php esc_attr_e( 'End Color', 'civitas' ); ?></h4>
