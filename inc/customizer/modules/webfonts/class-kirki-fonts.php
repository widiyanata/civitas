...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'civitas' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'civitas' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'civitas' ),
			'200'       => esc_attr__( 'Light 200', 'civitas' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'civitas' ),
			'300'       => esc_attr__( 'Book 300', 'civitas' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'civitas' ),
			'400'       => esc_attr__( 'Normal 400', 'civitas' ),
			'regular'   => esc_attr__( 'Normal 400', 'civitas' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'civitas' ),
			'500'       => esc_attr__( 'Medium 500', 'civitas' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'civitas' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'civitas' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'civitas' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'civitas' ),
			'700'       => esc_attr__( 'Bold 700', 'civitas' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'civitas' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'civitas' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'civitas' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'civitas' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'civitas' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'civitas' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'civitas' ),
		);
	}
