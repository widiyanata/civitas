            ...
            <div class="col-md-12 col-sm-6 col-lg-12 col-xs-12 p-0">
              <article class="zm-trending-post zm-lay-c zm-single-post" data-dark-overlay="2.5" data-scrim-bottom="9" data-effict-zoom="1">
                ...
                <div class="zm-post-dis text-white">
                  ...
                  <h2 class="zm-post-title"><a href="#">Lorem ipsum dolor sit amet consectetur adipisicing.</a></h2>
            ...
            <div class="col-md-12 col-sm-6 col-lg-12 col-xs-12 p-0">
              <article class="zm-trending-post zm-lay-c zm-single-post" data-dark-overlay="2.5" data-scrim-bottom="9" data-effict-zoom="1">
                ...
                <div class="zm-post-dis text-white">
                  ...
                  <h2 class="zm-post-title"><a href="#">Ut enim ad minim veniam quis nostrud quie exercitation.</a></h2>
                  <div class="zm-post-meta">
                    <ul>
                      <li class="s-meta"><a href="#" class="zm-author">Thomson Smith</a></li>
                      <li class="s-meta"><a href="#" class="zm-date">April 18, 2016</a></li>
        ...
        <div class="p-0 col-md-6 col-lg-6 col-sm-12 col-xs-12">
          <article class="zm-trending-post zm-lay-c large zm-single-post" data-dark-overlay="2.5" data-scrim-bottom="9" data-effict-zoom="1">
            ...
            <div class="zm-post-dis text-white">
              ...
              <h2 class="zm-post-title"><a href="#">Sed do eiusmod tempor incididunt labore and magna aliqua ut enim minim veniam quis nostrud exercitation.</a></h2>
              <div class="zm-post-meta">
                <ul>
                  <li class="s-meta"><a href="#" class="zm-author">Thomson Smith</a></li>
                  <li class="s-meta"><a href="#" class="zm-date">April 18, 2016</a></li>
            ...
            <div class="col-md-12 col-sm-6 col-lg-12 col-xs-12 p-0">
              <article class="zm-trending-post zm-lay-c zm-single-post" data-dark-overlay="2.5" data-scrim-bottom="9" data-effict-zoom="1">
                ...
                <div class="zm-post-dis text-white">
                  ...
                  <h2 class="zm-post-title"><a href="#">Consectetur adipisicing elit sed do minim eiusmod tempor.</a></h2>
                  <div class="zm-post-meta">
                    <ul>
                      <li class="s-meta"><a href="#" class="zm-author">Thomson Smith</a></li>
                      <li class="s-meta"><a href="#" class="zm-date">April 18, 2016</a></li>
            ...
            <div class="col-md-12 col-sm-6 col-lg-12 col-xs-12 p-0">
              <article class="zm-trending-post zm-lay-c zm-single-post" data-dark-overlay="2.5" data-scrim-bottom="9" data-effict-zoom="1">
                ...
                <div class="zm-post-dis text-white">
                  ...
                  <h2 class="zm-post-title"><a href="#">Duis aute irure dolor in reprehenderit in voluptate.</a></h2>
                  <div class="zm-post-meta">
                    <ul>
                      <li class="s-meta"><a href="#" class="zm-author">Thomson Smith</a></li>
                      <li class="s-meta"><a href="#" class="zm-date">April 18, 2016</a></li>
